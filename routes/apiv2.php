...
Route::post('add_emergency', 'APIV2\General\EcpController@add_emergency');
Route::get('emergency_list', 'APIV2\General\EcpController@emergency_list');
Route::post('add_tip', 'APIV2\General\EcpController@add_tip');
Route::get('get_tip', 'APIV2\General\EcpController@get_tip_list');
