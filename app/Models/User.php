...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name','username', 'image', 'email', 'password', 'ward', 'constituency', 'section', 'chiefdom', 'district', 'province', 'street_name', 'street_number', 'gender', 'is_active', 'assign_district', 'assign_district_id','passkey_value','passkey_status' //'device_id'
    ];
