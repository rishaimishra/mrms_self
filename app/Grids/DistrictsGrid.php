...
class DistrictsGrid extends Grid implements DistrictsGridInterface
{
    /**
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('admin.districts.index');

        // crud support
        $this->setCreateRouteName('admin.districts.create');
        $this->setViewRouteName('admin.districts.show');
        $this->setDeleteRouteName('admin.district.delete');
