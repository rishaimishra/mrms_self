...
class InformationGrid extends Grid implements InformationGridInterface
{
    /**
     ...
     * @var string
     */
    protected $name = 'Information Collection';
    ...
    public function setRoutes()
    {
        ...
        $this->setViewRouteName('admin.information_show');
        $this->setDeleteRouteName('admin.information-delete');
