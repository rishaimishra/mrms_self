                                ...
                                <select name="assign_district" id="assign_district" class="form-control show-tick">
                                    ...
                                    <option value="">-- Select District Type --</option>
                                        ...
                                        @foreach($district as $key => $distric)
                                            <option value="{{$key}}" {{ old('assign_district',$app_user->assign_district_id)==$key?'selected': ''}}>{{ucfirst($distric)}}</option>
                                        @endforeach
                                </select>
                            @else
                                <select name="assign_district" id="assign_district" class="form-control show-tick" >
...
@push('scripts')
    ...
    <script>
        $(document).ready(function(){
            $("select#ward").val($("select#ward").val()).change();
        });
    </script>
@endpush  --}}
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    {!! Form::open(['novalidate' => 'novalidate', 'id' => 'update_user','route' => 'admin.guest-user.update']) !!}
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="first_name"
                                           value="{{isset($admin_user->name)==true?$admin_user->name:""}}"
                                           required>
                            ...
                            @hasrole('Super Admin')
                                <select name="assign_district" id="assign_district" class="form-control show-tick">
                                    ...
                                    <option value="">-- Select District Type --</option>
                                        ...
                                        @foreach($district as $key => $distric)
                                            <option value="{{$key}}" {{ old('assign_district',$admin_user->assign_district_id)==$key?'selected': ''}}>{{ucfirst($distric)}}</option>
                                        @endforeach
                                </select>
                            @else
                                <select name="assign_district" id="assign_district" class="form-control show-tick" >
