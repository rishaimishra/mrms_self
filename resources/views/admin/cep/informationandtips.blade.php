    ...
    <div class="card p_2" style="height: 100vh;">
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div class="border_cus">
                <div class="row">
                    <div class="col-md-12"><label for="">Information and tip</label></div>
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="information_tip" placeholder="enter information/tip here .......">
                    </div>
                </div>
