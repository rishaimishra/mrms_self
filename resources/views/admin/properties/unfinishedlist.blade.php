...
<table class="table table-bordered table-hover" style="background-color: #FFF;">
    ...
    <tr>
              ...
              <td> <img class="zoom" width="250" height="250" src="{{$any_variable->getUnfinishedImagePathAttribute()}}" alt="Image"/>  </td>
              <td> <a type="button" class="btn btn-primary"  target="_blank" href="https://www.google.com/maps/place/{{$any_variable->unfinished_property_lat}},{{$any_variable->unfinished_property_long}}">Open Location</a></td>
              <td> <p>{{$any_variable->unfinished_property_lat}},{{$any_variable->unfinished_property_long}}</p></td>
