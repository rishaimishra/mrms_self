                ...
                <div class="custom-width" style="font-family: arial; font-size: 11px">
                    ...
                    <table class="font-weight-bold table-font-size">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px;">{{$property->landlord->province}}</td>
                        </tr>
                        <tr>
...
{{--                        </tr>--}}
                        <tr>
                            ...
                            <td style="font-size: 12px;">Le {{($propertyPayment->amountPaid())}}</td>
                        </tr>
                        <tr>
